...
public class TOponlineProcessorDAOImpl implements TOnOrderNoteDAO {

	private SessionFactory sessionFactory;
	private Session session;
	private Query query;
	
	public TOponlineProcessorDAOImpl() {
		getSessionFactory();
	...
	public TOnOrderNote getOrderNoteById(int id) {
		String queryString = "from TOnOrderNote orderNote where orderNote.onNoteId = :id";
	...
	public TOnOrderNote getOrderNoteByName(String name) {
		String queryString = "from TOnOrderNote orderNote where orderNote.onNoteTx like CONCAT('%',:name,'%')";
		TOnOrderNote orderNote = new TOnOrderNote();
		query = session.createQuery(queryString);
