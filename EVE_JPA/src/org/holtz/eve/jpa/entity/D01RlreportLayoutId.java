...
/**
 * D01RlreportLayoutId generated by hbm2java
 */
@Embeddable
public class D01RlreportLayoutId implements java.io.Serializable {
	...
	public D01RlreportLayoutId() {
	}

	public D01RlreportLayoutId(int rlreportLayoutId, String rlreportLayoutTx, int rlreportTypeId,
			...
			int rlleftMarginIn, int rltopMarginIn, int rllanguageId, int rltmpId) {
	...
	public D01RlreportLayoutId(int rlreportLayoutId, String rlreportLayoutTx, int rlreportTypeId,
			int rlpaperSizeId, short rldestinationId, short rlcopiesIn, boolean rllandscapeBl, boolean rluseMarginsBl,
			boolean rlunavailableBl, boolean rlscaleToFitXbl, boolean rlscaleToFitYbl, boolean rluseDbpaperSizeBl,
			int rlleftMarginIn, int rltopMarginIn, int rllanguageId, String rltmpNameTxN, int rltmpId) {
		this.rlreportLayoutId = rlreportLayoutId;
		this.rlreportLayoutTx = rlreportLayoutTx;
		this.rlreportTypeId = rlreportTypeId;
		this.rlpaperSizeId = rlpaperSizeId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof D01RlreportLayoutId))
			return false;
		D01RlreportLayoutId castOther = (D01RlreportLayoutId) other;
		...
		return (this.getRlreportLayoutId() == castOther.getRlreportLayoutId())
				...
				&& (this.getRlleftMarginIn() == castOther.getRlleftMarginIn())
				&& (this.getRltopMarginIn() == castOther.getRltopMarginIn())
				&& (this.getRllanguageId() == castOther.getRllanguageId())
				&& ((this.getRltmpNameTxN() == castOther.getRltmpNameTxN())
						|| (this.getRltmpNameTxN() != null && castOther.getRltmpNameTxN() != null
								&& this.getRltmpNameTxN().equals(castOther.getRltmpNameTxN())))
				&& (this.getRltmpId() == castOther.getRltmpId());
	}
	...
	public int hashCode() {
		...
		result = 37 * result + this.getRlleftMarginIn();
		result = 37 * result + this.getRltopMarginIn();
		result = 37 * result + this.getRllanguageId();
		result = 37 * result + (getRltmpNameTxN() == null ? 0 : this.getRltmpNameTxN().hashCode());
		result = 37 * result + this.getRltmpId();
		return result;
	}
