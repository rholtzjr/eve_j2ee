...
/**
 * S01CdCustOrderId generated by hbm2java
 */
@Embeddable
public class S01CdCustOrderId implements java.io.Serializable {
	...
	public S01CdCustOrderId() {
	}

	public S01CdCustOrderId(int cdCustOrderId, int cdEmpId, int cdCustId, int cdStockItemId, short cdStoreId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof S01CdCustOrderId))
			return false;
		S01CdCustOrderId castOther = (S01CdCustOrderId) other;
