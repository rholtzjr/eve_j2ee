...
/**
 * S01GcgiftCertId generated by hbm2java
 */
@Embeddable
public class S01GcgiftCertId implements java.io.Serializable {
	...
	public S01GcgiftCertId() {
	}

	public S01GcgiftCertId(int gcgiftCertId, int gcpurchasedById, int gcownedById, short gcstoreId, int gccostCenterId,
	...
	public S01GcgiftCertId(int gcgiftCertId, String gcgiftCertNoTx, int gcpurchasedById, int gcownedById,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof S01GcgiftCertId))
			return false;
		S01GcgiftCertId castOther = (S01GcgiftCertId) other;
