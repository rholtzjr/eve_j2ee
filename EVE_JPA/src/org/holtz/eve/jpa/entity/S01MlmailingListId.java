...
/**
 * S01MlmailingListId generated by hbm2java
 */
@Embeddable
public class S01MlmailingListId implements java.io.Serializable {
	...
	public S01MlmailingListId() {
	}

	public S01MlmailingListId(int mlmailingListId, String mlmailingListTx, boolean mlunavailableBl,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof S01MlmailingListId))
			return false;
		S01MlmailingListId castOther = (S01MlmailingListId) other;
