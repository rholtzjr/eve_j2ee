...
/**
 * TAsAspnetSchemaVersionsId generated by hbm2java
 */
@Embeddable
public class TAsAspnetSchemaVersionsId implements java.io.Serializable {

	private String feature;
	private String compatibleSchemaVersion;

	public TAsAspnetSchemaVersionsId() {
	}

	public TAsAspnetSchemaVersionsId(String feature, String compatibleSchemaVersion) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TAsAspnetSchemaVersionsId))
			return false;
		TAsAspnetSchemaVersionsId castOther = (TAsAspnetSchemaVersionsId) other;
