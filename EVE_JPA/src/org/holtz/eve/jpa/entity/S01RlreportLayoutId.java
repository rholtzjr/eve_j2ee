...
/**
 * S01RlreportLayoutId generated by hbm2java
 */
@Embeddable
public class S01RlreportLayoutId implements java.io.Serializable {
	...
	public S01RlreportLayoutId() {
	}

	public S01RlreportLayoutId(int rlreportLayoutId, String rlreportLayoutTx, int rlreportTypeId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof S01RlreportLayoutId))
			return false;
		S01RlreportLayoutId castOther = (S01RlreportLayoutId) other;
