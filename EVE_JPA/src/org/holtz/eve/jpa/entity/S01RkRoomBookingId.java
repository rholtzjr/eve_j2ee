...
/**
 * S01RkRoomBookingId generated by hbm2java
 */
@Embeddable
public class S01RkRoomBookingId implements java.io.Serializable {
	...
	public S01RkRoomBookingId() {
	}

	public S01RkRoomBookingId(int rkRoomBookingId, int rkCustId, int rkStatusId, Date rkStartDate, Date rkEndDate,
	...
	public S01RkRoomBookingId(int rkRoomBookingId, Integer rkHotelIdN, Integer rkRoomIdN, String rkRoomNoTxN,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof S01RkRoomBookingId))
			return false;
		S01RkRoomBookingId castOther = (S01RkRoomBookingId) other;
