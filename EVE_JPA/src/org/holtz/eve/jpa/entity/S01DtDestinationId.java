...
/**
 * S01DtDestinationId generated by hbm2java
 */
@Embeddable
public class S01DtDestinationId implements java.io.Serializable {
	...
	public S01DtDestinationId() {
	}

	public S01DtDestinationId(int dtDestinationId, String dtDestinationTx, boolean dtUnavailableBl,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof S01DtDestinationId))
			return false;
		S01DtDestinationId castOther = (S01DtDestinationId) other;
