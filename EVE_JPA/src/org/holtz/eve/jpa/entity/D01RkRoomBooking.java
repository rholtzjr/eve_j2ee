...
/**
 * D01RkRoomBooking generated by hbm2java
 */
@Entity
@Table(name = "d01_RkRoomBooking")
public class D01RkRoomBooking implements java.io.Serializable {

	private D01RkRoomBookingId id;

	public D01RkRoomBooking() {
	}

	public D01RkRoomBooking(D01RkRoomBookingId id) {
		this.id = id;
	}
	...
	public D01RkRoomBookingId getId() {
		return this.id;
	}

	public void setId(D01RkRoomBookingId id) {
		this.id = id;
	}
