...
/**
 * S01TkTaskId generated by hbm2java
 */
@Embeddable
public class S01TkTaskId implements java.io.Serializable {
	...
	public S01TkTaskId(int tkTaskId, Date tkDueStartDate, Date tkDueEndDate, Date tkReminderDate, int tkTaskTypeId,
	...
	public S01TkTaskId(int tkTaskId, Integer tkEmpIdN, Date tkDueStartDate, Date tkDueEndDate, Date tkReminderDate,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof S01TkTaskId))
			return false;
		S01TkTaskId castOther = (S01TkTaskId) other;
