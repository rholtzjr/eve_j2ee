...
/**
 * EmailAgentCourseEnrollmentsId generated by hbm2java
 */
@Embeddable
public class EmailAgentCourseEnrollmentsId implements java.io.Serializable {

	private int custCourseId;
	private String courseType;
	private String courseNo;
	private String courseStartDate;
	private String earliestModuleDate;
	private String earliestModuleTime;
	private Integer earliestModuleTypeId1;
	private int custId;
	private String firstName;
	private String middleInitial;
	private String lastName;
	private String knownAs;
	private String knownAsOrFirstName;
...
//	private int certTypeId;
	...
	public EmailAgentCourseEnrollmentsId(int custCourseId, String courseType, int custId, String firstName,
			String lastName, Date creationDate, Date lastUpdatedDate, boolean referral, boolean preRegistration,
			int courseTypeId, int enrollmentStatusId, short picstatusId, short storeId, int certTypeId) {
...
//		this.certTypeId = certTypeId;
	...
	public EmailAgentCourseEnrollmentsId(int custCourseId, String courseType, String courseNo,
			String courseStartDate, String earliestModuleDate, String earliestModuleTime, Integer earliestModuleTypeId1,
			int custId, String firstName, String middleInitial, String lastName, String knownAs,
			String knownAsOrFirstName, Date birthDate, Date nextBirthDay, Date previousBirthDay, Integer age,
			...
			String instructor, String courseLocation, String courseNotes, String courseStatus,
			String courseLanguage, Date creationDate, Date lastUpdatedDate, boolean referral,
			String enrollmentStatus, String picstatus, String referralStoreNo,
			boolean preRegistration, String certNotes, String certType, String scubaTribeCode,
			int courseTypeId, Integer courseId, Integer instructorId, int enrollmentStatusId, short picstatusId,
			Integer piccardId, Integer returnCardToId, Integer picprocessedById, Integer courseLocationId,
			Integer courseStatusId, Integer courseLanguageId, short storeId, Integer homeStateId, Integer homeCountryId,
			int certTypeId) {
		this.custCourseId = custCourseId;
		this.courseType = courseType;
		this.courseNo = courseNo;
		this.courseStartDate = courseStartDate;
		this.earliestModuleDate = earliestModuleDate;
		this.earliestModuleTime = earliestModuleTime;
		this.earliestModuleTypeId1 = earliestModuleTypeId1;
		this.custId = custId;
		this.firstName = firstName;
		this.middleInitial = middleInitial;
		this.lastName = lastName;
		this.knownAs = knownAs;
		this.knownAsOrFirstName = knownAsOrFirstName;
...
//		this.certTypeId = certTypeId;
	...
	@Column(name = "CourseStartDate", length = 30)
	...
	@Column(name = "EarliestModuleDate", length = 30)
	public String getEarliestModuleDate() {
		return this.earliestModuleDate;
	}

	public void setEarliestModuleDate(String earliestModuleDate) {
		this.earliestModuleDate = earliestModuleDate;
	}

	@Column(name = "EarliestModuleTime", length = 5)
	public String getEarliestModuleTime() {
		return this.earliestModuleTime;
	}

	public void setEarliestModuleTime(String earliestModuleTime) {
		this.earliestModuleTime = earliestModuleTime;
	}

	@Column(name = "EarliestModuleTypeID1")
	public Integer getEarliestModuleTypeId1() {
		return this.earliestModuleTypeId1;
	}

	public void setEarliestModuleTypeId1(Integer earliestModuleTypeId1) {
		this.earliestModuleTypeId1 = earliestModuleTypeId1;
	}
	...
	@Column(name = "KnownAsOrFirstName")
	public String getKnownAsOrFirstName() {
		return this.knownAsOrFirstName;
	}

	public void setKnownAsOrFirstName(String knownAsOrFirstName) {
		this.knownAsOrFirstName = knownAsOrFirstName;
	}
...
//	}
	...
	public Integer getCourseLanguageId() {
		return this.courseLanguageId;
	}

	public void setCourseLanguageId(Integer courseLanguageId) {
		this.courseLanguageId = courseLanguageId;
	}
...
//	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EmailAgentCourseEnrollmentsId))
			return false;
		EmailAgentCourseEnrollmentsId castOther = (EmailAgentCourseEnrollmentsId) other;
		...
		return (this.getCustCourseId() == castOther.getCustCourseId())
				...
				&& ((this.getEarliestModuleDate() == castOther.getEarliestModuleDate())
						|| (this.getEarliestModuleDate() != null && castOther.getEarliestModuleDate() != null
								&& this.getEarliestModuleDate().equals(castOther.getEarliestModuleDate())))
				&& ((this.getEarliestModuleTime() == castOther.getEarliestModuleTime())
						|| (this.getEarliestModuleTime() != null && castOther.getEarliestModuleTime() != null
								&& this.getEarliestModuleTime().equals(castOther.getEarliestModuleTime())))
				&& ((this.getEarliestModuleTypeId1() == castOther.getEarliestModuleTypeId1())
						|| (this.getEarliestModuleTypeId1() != null && castOther.getEarliestModuleTypeId1() != null
								&& this.getEarliestModuleTypeId1().equals(castOther.getEarliestModuleTypeId1())))
				...
				&& ((this.getKnownAsOrFirstName() == castOther.getKnownAsOrFirstName())
						|| (this.getKnownAsOrFirstName() != null && castOther.getKnownAsOrFirstName() != null
								&& this.getKnownAsOrFirstName().equals(castOther.getKnownAsOrFirstName())))
				...
				&& ((this.getInstructor() == castOther.getInstructor()) || (this.getInstructor() != null
						&& castOther.getInstructor() != null && this.getInstructor().equals(castOther.getInstructor())))
				&& ((this.getCourseLocation() == castOther.getCourseLocation())
						|| (this.getCourseLocation() != null && castOther.getCourseLocation() != null
								&& this.getCourseLocation().equals(castOther.getCourseLocation())))
				&& ((this.getCourseNotes() == castOther.getCourseNotes())
						|| (this.getCourseNotes() != null && castOther.getCourseNotes() != null
								&& this.getCourseNotes().equals(castOther.getCourseNotes())))
				&& ((this.getCourseStatus() == castOther.getCourseStatus())
						|| (this.getCourseStatus() != null && castOther.getCourseStatus() != null
								&& this.getCourseStatus().equals(castOther.getCourseStatus())))
				&& ((this.getCourseLanguage() == castOther.getCourseLanguage())
						|| (this.getCourseLanguage() != null && castOther.getCourseLanguage() != null
								&& this.getCourseLanguage().equals(castOther.getCourseLanguage())))
...
//						&& castOther.getCertType() != null && this.getCertType().equals(castOther.getCertType())))
				...
				&& ((this.getCourseLocationId() == castOther.getCourseLocationId())
						|| (this.getCourseLocationId() != null && castOther.getCourseLocationId() != null
								&& this.getCourseLocationId().equals(castOther.getCourseLocationId())))
				&& ((this.getCourseStatusId() == castOther.getCourseStatusId())
						|| (this.getCourseStatusId() != null && castOther.getCourseStatusId() != null
								&& this.getCourseStatusId().equals(castOther.getCourseStatusId())))
				&& ((this.getCourseLanguageId() == castOther.getCourseLanguageId())
						|| (this.getCourseLanguageId() != null && castOther.getCourseLanguageId() != null
								&& this.getCourseLanguageId().equals(castOther.getCourseLanguageId())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getEarliestModuleDate() == null ? 0 : this.getEarliestModuleDate().hashCode());
		result = 37 * result + (getEarliestModuleTime() == null ? 0 : this.getEarliestModuleTime().hashCode());
		result = 37 * result + (getEarliestModuleTypeId1() == null ? 0 : this.getEarliestModuleTypeId1().hashCode());
		...
		result = 37 * result + (getKnownAsOrFirstName() == null ? 0 : this.getKnownAsOrFirstName().hashCode());
		...
		result = 37 * result + (getInstructor() == null ? 0 : this.getInstructor().hashCode());
		result = 37 * result + (getCourseLocation() == null ? 0 : this.getCourseLocation().hashCode());
		result = 37 * result + (getCourseNotes() == null ? 0 : this.getCourseNotes().hashCode());
		result = 37 * result + (getCourseStatus() == null ? 0 : this.getCourseStatus().hashCode());
		result = 37 * result + (getCourseLanguage() == null ? 0 : this.getCourseLanguage().hashCode());
...
//		result = 37 * result + (getCertType() == null ? 0 : this.getCertType().hashCode());
		...
		result = 37 * result + (getCourseLocationId() == null ? 0 : this.getCourseLocationId().hashCode());
		result = 37 * result + (getCourseStatusId() == null ? 0 : this.getCourseStatusId().hashCode());
		result = 37 * result + (getCourseLanguageId() == null ? 0 : this.getCourseLanguageId().hashCode());
