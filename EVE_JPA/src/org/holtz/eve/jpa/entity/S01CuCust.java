...
/**
 * S01CuCust generated by hbm2java
 */
@Entity
@Table(name = "s01_CuCust")
public class S01CuCust implements java.io.Serializable {

	private S01CuCustId id;

	public S01CuCust() {
	}

	public S01CuCust(S01CuCustId id) {
		this.id = id;
	}
	...
	public S01CuCustId getId() {
		return this.id;
	}

	public void setId(S01CuCustId id) {
		this.id = id;
	}
