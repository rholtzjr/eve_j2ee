...
/**
 * S01CtcourseType generated by hbm2java
 */
@Entity
@Table(name = "s01_CTCourseType")
public class S01CtcourseType implements java.io.Serializable {

	private S01CtcourseTypeId id;

	public S01CtcourseType() {
	}

	public S01CtcourseType(S01CtcourseTypeId id) {
		this.id = id;
	}
	...
	public S01CtcourseTypeId getId() {
		return this.id;
	}

	public void setId(S01CtcourseTypeId id) {
		this.id = id;
	}
