...
/**
 * S01GdGiftCard generated by hbm2java
 */
@Entity
@Table(name = "s01_GdGiftCard")
public class S01GdGiftCard implements java.io.Serializable {

	private S01GdGiftCardId id;

	public S01GdGiftCard() {
	}

	public S01GdGiftCard(S01GdGiftCardId id) {
		this.id = id;
	}
	...
	public S01GdGiftCardId getId() {
		return this.id;
	}

	public void setId(S01GdGiftCardId id) {
		this.id = id;
	}
