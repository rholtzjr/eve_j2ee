...
/**
 * S01E2emailQueue generated by hbm2java
 */
@Entity
@Table(name = "s01_E2EmailQueue")
public class S01E2emailQueue implements java.io.Serializable {

	private S01E2emailQueueId id;

	public S01E2emailQueue() {
	}

	public S01E2emailQueue(S01E2emailQueueId id) {
		this.id = id;
	}
	...
	public S01E2emailQueueId getId() {
		return this.id;
	}

	public void setId(S01E2emailQueueId id) {
		this.id = id;
	}
