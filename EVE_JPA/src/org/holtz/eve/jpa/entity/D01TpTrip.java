...
/**
 * D01TpTrip generated by hbm2java
 */
@Entity
@Table(name = "d01_TpTrip")
public class D01TpTrip implements java.io.Serializable {

	private D01TpTripId id;

	public D01TpTrip() {
	}

	public D01TpTrip(D01TpTripId id) {
		this.id = id;
	}
	...
	public D01TpTripId getId() {
		return this.id;
	}

	public void setId(D01TpTripId id) {
		this.id = id;
	}
