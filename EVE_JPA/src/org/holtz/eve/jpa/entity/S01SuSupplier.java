...
/**
 * S01SuSupplier generated by hbm2java
 */
@Entity
@Table(name = "s01_SuSupplier")
public class S01SuSupplier implements java.io.Serializable {

	private S01SuSupplierId id;

	public S01SuSupplier() {
	}

	public S01SuSupplier(S01SuSupplierId id) {
		this.id = id;
	}
	...
	public S01SuSupplierId getId() {
		return this.id;
	}

	public void setId(S01SuSupplierId id) {
		this.id = id;
	}
